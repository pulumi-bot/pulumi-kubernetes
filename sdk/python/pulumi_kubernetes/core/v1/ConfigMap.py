...
class ConfigMap(pulumi.CustomResource):
    ...
    """
    binary_data: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("binaryData")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, binary_data: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, data: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, immutable: Optional[pulumi.Input[bool]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'ConfigMap':
        """
