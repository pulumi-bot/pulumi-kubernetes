...
class Secret(pulumi.CustomResource):
    ...
    """
    data: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("data")
    """
    Data contains the secret data. Each key must consist of alphanumeric characters, '-', '_' or '.'. The serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string) data value here. Described in https://tools.ietf.org/html/rfc4648#section-4
    """
    immutable: pulumi.Output[Optional[bool]] = pulumi.output_property("immutable")
    """
    ...
    """
    string_data: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("stringData")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, data: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, immutable: Optional[pulumi.Input[bool]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, string_data: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, type: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'Secret':
        """
