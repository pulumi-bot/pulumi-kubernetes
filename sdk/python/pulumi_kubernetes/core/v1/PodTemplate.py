...
class PodTemplate(pulumi.CustomResource):
    ...
    """
    template: pulumi.Output[Optional['outputs.PodTemplateSpec']] = pulumi.output_property("template")
    """
    Template defines the pods that will be created from this pod template. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version=None, kind=None, metadata=None, template=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
