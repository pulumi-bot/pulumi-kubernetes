...
class PersistentVolumeClaim(pulumi.CustomResource):
    ...
    """
    spec: pulumi.Output[Optional['outputs.PersistentVolumeClaimSpec']] = pulumi.output_property("spec")
    """
    Spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    """
    status: pulumi.Output[Optional['outputs.PersistentVolumeClaimStatus']] = pulumi.output_property("status")
    """
    Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, spec: Optional[pulumi.Input[pulumi.InputType['PersistentVolumeClaimSpecArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'PersistentVolumeClaim':
        """
