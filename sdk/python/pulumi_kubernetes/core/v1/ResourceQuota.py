...
class ResourceQuota(pulumi.CustomResource):
    ...
    """
    spec: pulumi.Output[Optional['outputs.ResourceQuotaSpec']] = pulumi.output_property("spec")
    """
    Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: pulumi.Output[Optional['outputs.ResourceQuotaStatus']] = pulumi.output_property("status")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'ResourceQuota':
        """
