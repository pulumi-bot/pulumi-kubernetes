...
class ReplicationController(pulumi.CustomResource):
    ...
    """
    spec: pulumi.Output[Optional['outputs.ReplicationControllerSpec']] = pulumi.output_property("spec")
    """
    Spec defines the specification of the desired behavior of the replication controller. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: pulumi.Output[Optional['outputs.ReplicationControllerStatus']] = pulumi.output_property("status")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'ReplicationController':
        """
