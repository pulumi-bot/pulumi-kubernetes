...
class ComponentStatus(pulumi.CustomResource):
    ...
    """
    conditions: pulumi.Output[Optional[List['outputs.ComponentCondition']]] = pulumi.output_property("conditions")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, conditions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ComponentConditionArgs']]]]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ComponentConditionArgs']]]] conditions: List of component conditions observed
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'ComponentStatus':
        """
