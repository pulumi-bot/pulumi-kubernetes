...
class ComponentStatus(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version=None, conditions=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
