...
class JobArgs:
    ...
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['JobSpecArgs']] = None, status: Optional[pulumi.Input['JobStatusArgs']] = None) -> None:
        """
...
class JobSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, template: pulumi.Input['PodTemplateSpecArgs'], active_deadline_seconds: Optional[pulumi.Input[float]] = None, backoff_limit: Optional[pulumi.Input[float]] = None, completions: Optional[pulumi.Input[float]] = None, manual_selector: Optional[pulumi.Input[bool]] = None, parallelism: Optional[pulumi.Input[float]] = None, selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, ttl_seconds_after_finished: Optional[pulumi.Input[float]] = None) -> None:
        """
        JobSpec describes how the job execution will look like.
        :param pulumi.Input['PodTemplateSpecArgs'] template: Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
        ...
        :param pulumi.Input['LabelSelectorArgs'] selector: A label query over pods that should match the pod count. Normally, the system sets this field for you. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
