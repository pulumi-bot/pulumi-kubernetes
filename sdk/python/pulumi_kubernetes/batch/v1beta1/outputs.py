...
class CronJobStatus(dict):
    ...
    """
    active: Optional[List['_core.v1.outputs.ObjectReference']] = pulumi.output_property("active")
    """
...
class JobTemplateSpec(dict):
    ...
    """
    spec: Optional['_batch.v1.outputs.JobSpec'] = pulumi.output_property("spec")
    """
