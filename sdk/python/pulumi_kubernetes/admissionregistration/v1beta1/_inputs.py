...
class MutatingWebhookArgs:
    ...
    """
    admission_review_versions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = pulumi.input_property("admissionReviewVersions")
    """
    AdmissionReviewVersions is an ordered list of preferred `AdmissionReview` versions the Webhook expects. API server will try to use first version in the list which it supports. If none of the versions specified in this list supported by API server, validation will fail for this object. If a persisted webhook configuration specifies allowed versions and does not include any versions known to the API Server, calls to the webhook will fail and be subject to the failure policy. Default to `['v1beta1']`.
    """
    failure_policy: Optional[pulumi.Input[str]] = pulumi.input_property("failurePolicy")
    """
    FailurePolicy defines how unrecognized errors from the admission endpoint are handled - allowed values are Ignore or Fail. Defaults to Ignore.
    """
    match_policy: Optional[pulumi.Input[str]] = pulumi.input_property("matchPolicy")
    """
    ...
    """
    object_selector: Optional[pulumi.Input['LabelSelectorArgs']] = pulumi.input_property("objectSelector")
    """
    ObjectSelector decides whether to run the webhook based on if the object has matching labels. objectSelector is evaluated against both the oldObject and newObject that would be sent to the webhook, and is considered to match if either object matches the selector. A null object (oldObject in the case of create, or newObject in the case of delete) or an object that cannot have labels (like a DeploymentRollback or a PodProxyOptions object) is not considered to match. Use the object selector only if the webhook is opt-in, because end users may skip the admission webhook by setting the labels. Default to the empty LabelSelector, which matches everything.
    """
    reinvocation_policy: Optional[pulumi.Input[str]] = pulumi.input_property("reinvocationPolicy")
    """
    ...
    Defaults to "Never".
    """
    rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = pulumi.input_property("rules")
    """
    Rules describes what operations on what resources/subresources the webhook cares about. The webhook cares about an operation if it matches _any_ Rule. However, in order to prevent ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks from putting the cluster in a state which cannot be recovered from without completely disabling the plugin, ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks are never called on admission requests for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects.
    """
    side_effects: Optional[pulumi.Input[str]] = pulumi.input_property("sideEffects")
    """
    ...
    def __init__(__self__, *, client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], admission_review_versions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, reinvocation_policy: Optional[pulumi.Input[str]] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, side_effects: Optional[pulumi.Input[str]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
        ...
        :param pulumi.Input[str] match_policy: matchPolicy defines how the "rules" list is used to match incoming requests. Allowed values are "Exact" or "Equivalent".
               ...
               Defaults to "Exact"
        :param pulumi.Input['LabelSelectorArgs'] namespace_selector: NamespaceSelector decides whether to run the webhook on an object based on whether the namespace for that object matches the selector. If the object itself is a namespace, the matching is performed on object.metadata.labels. If the object is another cluster scoped resource, it never skips the webhook.
               ...
               Default to the empty LabelSelector, which matches everything.
        :param pulumi.Input['LabelSelectorArgs'] object_selector: ObjectSelector decides whether to run the webhook based on if the object has matching labels. objectSelector is evaluated against both the oldObject and newObject that would be sent to the webhook, and is considered to match if either object matches the selector. A null object (oldObject in the case of create, or newObject in the case of delete) or an object that cannot have labels (like a DeploymentRollback or a PodProxyOptions object) is not considered to match. Use the object selector only if the webhook is opt-in, because end users may skip the admission webhook by setting the labels. Default to the empty LabelSelector, which matches everything.
        ...
        __self__.name = name
        __self__.admission_review_versions = admission_review_versions
        __self__.failure_policy = failure_policy
        __self__.match_policy = match_policy
        __self__.namespace_selector = namespace_selector
        __self__.object_selector = object_selector
        __self__.reinvocation_policy = reinvocation_policy
        __self__.rules = rules
        __self__.side_effects = side_effects
...
class MutatingWebhookConfigurationArgs:
    ...
    """
    webhooks: Optional[pulumi.Input[List[pulumi.Input['MutatingWebhookArgs']]]] = pulumi.input_property("webhooks")
    """
    Webhooks is a list of webhooks and the affected resources and operations.
    """

    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, webhooks: Optional[pulumi.Input[List[pulumi.Input['MutatingWebhookArgs']]]] = None) -> None:
        """
        ...
        """
        __self__.api_version = 'admissionregistration.k8s.io/v1beta1'
        __self__.kind = 'MutatingWebhookConfiguration'
...
class RuleWithOperationsArgs:
    ...
    """
    api_versions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = pulumi.input_property("apiVersions")
    """
    APIVersions is the API versions the resources belong to. '*' is all versions. If '*' is present, the length of the slice must be one. Required.
    """
    operations: Optional[pulumi.Input[List[pulumi.Input[str]]]] = pulumi.input_property("operations")
    """
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_groups: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, api_versions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, operations: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resources: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, scope: Optional[pulumi.Input[str]] = None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] operations: Operations is the operations the admission hook cares about - CREATE, UPDATE, or * for all operations. If '*' is present, the length of the slice must be one. Required.
        ...
        __self__.api_versions = api_versions
...
class ValidatingWebhookArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], admission_review_versions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, side_effects: Optional[pulumi.Input[str]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
...
class ValidatingWebhookConfigurationArgs:
    ...
    Standard object metadata; More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
    """
    webhooks: Optional[pulumi.Input[List[pulumi.Input['ValidatingWebhookArgs']]]] = pulumi.input_property("webhooks")
    """
    Webhooks is a list of webhooks and the affected resources and operations.
    """

    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, webhooks: Optional[pulumi.Input[List[pulumi.Input['ValidatingWebhookArgs']]]] = None) -> None:
        """
        ...
        """
        __self__.api_version = 'admissionregistration.k8s.io/v1beta1'
        __self__.kind = 'ValidatingWebhookConfiguration'
        __self__.metadata = metadata
        __self__.webhooks = webhooks
