...
class MutatingWebhookArgs:
    admission_review_versions: pulumi.Input[List[pulumi.Input[str]]] = pulumi.input_property("admissionReviewVersions")
    """
    ...
    """
    side_effects: pulumi.Input[str] = pulumi.input_property("sideEffects")
    """
    ...
    def __init__(__self__, *, admission_review_versions: pulumi.Input[List[pulumi.Input[str]]], client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], side_effects: pulumi.Input[str], failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, reinvocation_policy: Optional[pulumi.Input[str]] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
...
class MutatingWebhookConfigurationArgs:
    ...
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, webhooks: Optional[pulumi.Input[List[pulumi.Input['MutatingWebhookArgs']]]] = None) -> None:
        ...
        """
        __self__.api_version = 'admissionregistration.k8s.io/v1'
...
class ValidatingWebhookArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, admission_review_versions: pulumi.Input[List[pulumi.Input[str]]], client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], side_effects: pulumi.Input[str], failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
