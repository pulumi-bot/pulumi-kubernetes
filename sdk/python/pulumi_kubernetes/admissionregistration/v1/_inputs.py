...
class MutatingWebhookArgs:
    ...
    def __init__(__self__, *, admission_review_versions: pulumi.Input[List[pulumi.Input[str]]], client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], side_effects: pulumi.Input[str], failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None, reinvocation_policy: Optional[pulumi.Input[str]] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
...
class ValidatingWebhookArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, admission_review_versions: pulumi.Input[List[pulumi.Input[str]]], client_config: pulumi.Input['WebhookClientConfigArgs'], name: pulumi.Input[str], side_effects: pulumi.Input[str], failure_policy: Optional[pulumi.Input[str]] = None, match_policy: Optional[pulumi.Input[str]] = None, namespace_selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None, object_selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None, rules: Optional[pulumi.Input[List[pulumi.Input['RuleWithOperationsArgs']]]] = None, timeout_seconds: Optional[pulumi.Input[float]] = None) -> None:
        """
