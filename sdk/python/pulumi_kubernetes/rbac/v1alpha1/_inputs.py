...
class AggregationRuleArgs:
    cluster_role_selectors: Optional[pulumi.Input[List[pulumi.Input['LabelSelectorArgs']]]] = pulumi.input_property("clusterRoleSelectors")
    """
    ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
    """

    # pylint: disable=no-self-argument
    def __init__(__self__, *, cluster_role_selectors: Optional[pulumi.Input[List[pulumi.Input['LabelSelectorArgs']]]] = None) -> None:
        """
        AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole
        :param pulumi.Input[List[pulumi.Input['LabelSelectorArgs']]] cluster_role_selectors: ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
        """
...
class ClusterRoleArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, aggregation_rule: Optional[pulumi.Input['AggregationRuleArgs']] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, rules: Optional[pulumi.Input[List[pulumi.Input['PolicyRuleArgs']]]] = None) -> None:
        """
...
class ClusterRoleBindingArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, role_ref: pulumi.Input['RoleRefArgs'], api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, subjects: Optional[pulumi.Input[List[pulumi.Input['SubjectArgs']]]] = None) -> None:
        """
...
class RoleArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, rules: Optional[pulumi.Input[List[pulumi.Input['PolicyRuleArgs']]]] = None) -> None:
        """
