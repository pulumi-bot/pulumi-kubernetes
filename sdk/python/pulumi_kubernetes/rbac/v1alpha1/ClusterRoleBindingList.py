...
class ClusterRoleBindingList(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version=None, items=None, kind=None, metadata=None, __props__=None, __name__=None, __opts__=None) -> None:
        ...
        :param pulumi.Input[List[pulumi.Input['ClusterRoleBindingArgs']]] items: Items is a list of ClusterRoleBindings
        :param pulumi.Input[str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['ListMetaArgs'] metadata: Standard object's metadata.
        """
