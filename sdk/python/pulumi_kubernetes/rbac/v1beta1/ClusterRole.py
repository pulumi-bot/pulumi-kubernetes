...
class ClusterRole(pulumi.CustomResource):
    aggregation_rule: pulumi.Output[Optional['outputs.AggregationRule']] = pulumi.output_property("aggregationRule")
    """
    ...
    """
    rules: pulumi.Output[Optional[List['outputs.PolicyRule']]] = pulumi.output_property("rules")
    """
    Rules holds all the PolicyRules for this ClusterRole
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, aggregation_rule: Optional[pulumi.Input[pulumi.InputType['AggregationRuleArgs']]] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicyRuleArgs']]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterRole':
        """
