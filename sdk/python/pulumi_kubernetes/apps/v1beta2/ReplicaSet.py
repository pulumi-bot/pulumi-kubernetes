...
class ReplicaSet(pulumi.CustomResource):
    ...
    """
    spec: pulumi.Output[Optional['outputs.ReplicaSetSpec']] = pulumi.output_property("spec")
    """
    Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    status: pulumi.Output[Optional['outputs.ReplicaSetStatus']] = pulumi.output_property("status")
    """
