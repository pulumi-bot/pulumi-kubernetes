...
class ControllerRevisionArgs:
    ...
    def __init__(__self__, *, revision: pulumi.Input[float], api_version: Optional[pulumi.Input[str]] = None, data: Optional[Any] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaArgs']] = None) -> None:
        """
...
class DaemonSetSpecArgs:
    selector: pulumi.Input['_meta.v1.LabelSelectorArgs'] = pulumi.input_property("selector")
    """
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['_meta.v1.LabelSelectorArgs'], template: pulumi.Input['_core.v1.PodTemplateSpecArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, update_strategy: Optional[pulumi.Input['DaemonSetUpdateStrategyArgs']] = None) -> None:
        """
...
class ReplicaSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['_meta.v1.LabelSelectorArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, replicas: Optional[pulumi.Input[float]] = None, template: Optional[pulumi.Input['_core.v1.PodTemplateSpecArgs']] = None) -> None:
        """
...
class StatefulSetArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['StatefulSetSpecArgs']] = None, status: Optional[pulumi.Input['StatefulSetStatusArgs']] = None) -> None:
        """
...
class StatefulSetSpecArgs:
    ...
    """
    volume_claim_templates: Optional[pulumi.Input[List[pulumi.Input['_core.v1.PersistentVolumeClaimArgs']]]] = pulumi.input_property("volumeClaimTemplates")
    """
    volumeClaimTemplates is a list of claims that pods are allowed to reference. The StatefulSet controller is responsible for mapping network identities to claims in a way that maintains the identity of a pod. Every claim in this list must have at least one matching (by name) volumeMount in one container in the template. A claim in this list takes precedence over any volumes in the template, with the same name.
    """

    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['_meta.v1.LabelSelectorArgs'], service_name: pulumi.Input[str], template: pulumi.Input['_core.v1.PodTemplateSpecArgs'], pod_management_policy: Optional[pulumi.Input[str]] = None, replicas: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, update_strategy: Optional[pulumi.Input['StatefulSetUpdateStrategyArgs']] = None, volume_claim_templates: Optional[pulumi.Input[List[pulumi.Input['_core.v1.PersistentVolumeClaimArgs']]]] = None) -> None:
        """
