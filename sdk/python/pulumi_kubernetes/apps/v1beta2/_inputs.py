...
class ControllerRevisionArgs:
    ...
    def __init__(__self__, *, revision: pulumi.Input[float], api_version: Optional[pulumi.Input[str]] = None, data: Optional[Any] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None) -> None:
        ...
        __self__.api_version = 'apps/v1beta2'
        __self__.data = data
...
class DaemonSetSpecArgs:
    selector: pulumi.Input['LabelSelectorArgs'] = pulumi.input_property("selector")
    """
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['LabelSelectorArgs'], template: pulumi.Input['PodTemplateSpecArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, update_strategy: Optional[pulumi.Input['DaemonSetUpdateStrategyArgs']] = None) -> None:
        """
        DaemonSetSpec is the specification of a daemon set.
        :param pulumi.Input['LabelSelectorArgs'] selector: A label query over pods that are managed by the daemon set. Must match in order to be controlled. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
...
class DeploymentSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['LabelSelectorArgs'], template: pulumi.Input['PodTemplateSpecArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, paused: Optional[pulumi.Input[bool]] = None, progress_deadline_seconds: Optional[pulumi.Input[float]] = None, replicas: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, strategy: Optional[pulumi.Input['DeploymentStrategyArgs']] = None) -> None:
        """
        DeploymentSpec is the specification of the desired behavior of the Deployment.
        :param pulumi.Input['LabelSelectorArgs'] selector: Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment. It must match the pod template's labels.
...
class ReplicaSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['LabelSelectorArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, replicas: Optional[pulumi.Input[float]] = None, template: Optional[pulumi.Input['PodTemplateSpecArgs']] = None) -> None:
        """
        ReplicaSetSpec is the specification of a ReplicaSet.
        :param pulumi.Input['LabelSelectorArgs'] selector: Selector is a label query over pods that should match the replica count. Label keys and values that must match in order to be controlled by this replica set. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
        :param pulumi.Input[float] min_ready_seconds: Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)
...
class StatefulSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, selector: pulumi.Input['LabelSelectorArgs'], service_name: pulumi.Input[str], template: pulumi.Input['PodTemplateSpecArgs'], pod_management_policy: Optional[pulumi.Input[str]] = None, replicas: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, update_strategy: Optional[pulumi.Input['StatefulSetUpdateStrategyArgs']] = None, volume_claim_templates: Optional[pulumi.Input[List[pulumi.Input['PersistentVolumeClaimArgs']]]] = None) -> None:
        """
        A StatefulSetSpec is the specification of a StatefulSet.
        :param pulumi.Input['LabelSelectorArgs'] selector: selector is a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
