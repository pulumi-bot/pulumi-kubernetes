...
class StatefulSet(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.StatefulSetSpec']] = pulumi.output_property("spec")
    """
    Spec defines the desired identities of pods in this set.
    """
    status: pulumi.Output[Optional['outputs.StatefulSetStatus']] = pulumi.output_property("status")
    """
    Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, spec: Optional[pulumi.Input[pulumi.InputType['StatefulSetSpecArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'StatefulSet':
        """
