...
class StatefulSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, service_name: pulumi.Input[str], template: pulumi.Input['_core.v1.PodTemplateSpecArgs'], pod_management_policy: Optional[pulumi.Input[str]] = None, replicas: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None, update_strategy: Optional[pulumi.Input['StatefulSetUpdateStrategyArgs']] = None, volume_claim_templates: Optional[pulumi.Input[List[pulumi.Input['_core.v1.PersistentVolumeClaimArgs']]]] = None) -> None:
        """
