...
class LocalSubjectAccessReview(pulumi.CustomResource):
    ...
    spec: pulumi.Output['outputs.SubjectAccessReviewSpec'] = pulumi.output_property("spec")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'LocalSubjectAccessReview':
        """
