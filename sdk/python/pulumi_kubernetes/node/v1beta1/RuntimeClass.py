...
class RuntimeClass(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version=None, handler=None, kind=None, metadata=None, overhead=None, scheduling=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
