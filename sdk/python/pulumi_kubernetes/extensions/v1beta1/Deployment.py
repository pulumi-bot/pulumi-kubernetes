...
class Deployment(pulumi.CustomResource):
    ...
    """
    spec: pulumi.Output[Optional['outputs.DeploymentSpec']] = pulumi.output_property("spec")
    """
    Specification of the desired behavior of the Deployment.
    """
    status: pulumi.Output[Optional['outputs.DeploymentStatus']] = pulumi.output_property("status")
    """
    Most recently observed status of the Deployment.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, spec: Optional[pulumi.Input[pulumi.InputType['DeploymentSpecArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'Deployment':
        """
