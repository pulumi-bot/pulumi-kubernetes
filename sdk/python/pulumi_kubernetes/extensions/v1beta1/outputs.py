...
class NetworkPolicyPeer(dict):
    ...
    """
    pod_selector: Optional['_meta.v1.outputs.LabelSelector'] = pulumi.output_property("podSelector")
    """
...
class NetworkPolicySpec(dict):
    ...
    """
    pod_selector: '_meta.v1.outputs.LabelSelector' = pulumi.output_property("podSelector")
    """
