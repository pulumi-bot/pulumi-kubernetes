...
class DaemonSetArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['DaemonSetSpecArgs']] = None, status: Optional[pulumi.Input['DaemonSetStatusArgs']] = None) -> None:
        """
...
class DaemonSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, template: pulumi.Input['PodTemplateSpecArgs'], min_ready_seconds: Optional[pulumi.Input[float]] = None, revision_history_limit: Optional[pulumi.Input[float]] = None, selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, template_generation: Optional[pulumi.Input[float]] = None, update_strategy: Optional[pulumi.Input['DaemonSetUpdateStrategyArgs']] = None) -> None:
        """
        DaemonSetSpec is the specification of a daemon set.
        :param pulumi.Input['PodTemplateSpecArgs'] template: An object that describes the pod that will be created. The DaemonSet will create exactly one copy of this pod on every node that matches the template's node selector (or on every node if no node selector is specified). More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
        ...
        :param pulumi.Input['LabelSelectorArgs'] selector: A label query over pods that are managed by the daemon set. Must match in order to be controlled. If empty, defaulted to labels on Pod template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
...
class ReplicaSetArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['ReplicaSetSpecArgs']] = None, status: Optional[pulumi.Input['ReplicaSetStatusArgs']] = None) -> None:
        """
        ReplicaSet ensures that a specified number of pod replicas are running at any given time.
        :param pulumi.Input[str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        :param pulumi.Input['ObjectMetaArgs'] metadata: If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
...
class ReplicaSetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, min_ready_seconds: Optional[pulumi.Input[float]] = None, replicas: Optional[pulumi.Input[float]] = None, selector: Optional[pulumi.Input['LabelSelectorArgs']] = None, template: Optional[pulumi.Input['PodTemplateSpecArgs']] = None) -> None:
        """
        ...
        :param pulumi.Input['LabelSelectorArgs'] selector: Selector is a label query over pods that should match the replica count. If the selector is empty, it is defaulted to the labels present on the pod template. Label keys and values that must match in order to be controlled by this replica set. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
        :param pulumi.Input['PodTemplateSpecArgs'] template: Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template
        """
        __self__.min_ready_seconds = min_ready_seconds
        __self__.replicas = replicas
        __self__.selector = selector
