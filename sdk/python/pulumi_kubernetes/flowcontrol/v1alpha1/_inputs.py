...
class FlowSchemaArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['FlowSchemaSpecArgs']] = None, status: Optional[pulumi.Input['FlowSchemaStatusArgs']] = None) -> None:
        """
        ...
        :param pulumi.Input['ObjectMetaArgs'] metadata: `metadata` is the standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
...
class PriorityLevelConfigurationArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['PriorityLevelConfigurationSpecArgs']] = None, status: Optional[pulumi.Input['PriorityLevelConfigurationStatusArgs']] = None) -> None:
        """
