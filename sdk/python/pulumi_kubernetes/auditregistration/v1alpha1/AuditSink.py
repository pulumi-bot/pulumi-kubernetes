...
class AuditSink(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.AuditSinkSpec']] = pulumi.output_property("spec")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'AuditSink':
        """
