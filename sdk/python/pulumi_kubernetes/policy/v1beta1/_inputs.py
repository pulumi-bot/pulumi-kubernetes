...
class PodDisruptionBudgetArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['PodDisruptionBudgetSpecArgs']] = None, status: Optional[pulumi.Input['PodDisruptionBudgetStatusArgs']] = None) -> None:
        """
...
class PodDisruptionBudgetSpecArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, max_unavailable: Optional[pulumi.Input[Union[float, str]]] = None, min_available: Optional[pulumi.Input[Union[float, str]]] = None, selector: Optional[pulumi.Input['_meta.v1.LabelSelectorArgs']] = None) -> None:
        """
