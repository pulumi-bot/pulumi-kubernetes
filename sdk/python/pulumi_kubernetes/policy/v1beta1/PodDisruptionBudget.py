...
class PodDisruptionBudget(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.PodDisruptionBudgetSpec']] = pulumi.output_property("spec")
    """
    Specification of the desired behavior of the PodDisruptionBudget.
    """
    status: pulumi.Output[Optional['outputs.PodDisruptionBudgetStatus']] = pulumi.output_property("status")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'PodDisruptionBudget':
        """
