...
class HorizontalPodAutoscalerList(pulumi.CustomResource):
    ...
    """
    items: pulumi.Output[List['outputs.HorizontalPodAutoscaler']] = pulumi.output_property("items")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, items: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['HorizontalPodAutoscalerArgs']]]]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ListMetaArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'HorizontalPodAutoscalerList':
        """
