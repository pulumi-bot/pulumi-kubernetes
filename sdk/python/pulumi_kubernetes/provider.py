...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, cluster=None, context=None, enable_dry_run=None, kubeconfig=None, namespace=None, render_yaml_to_directory=None, suppress_deprecation_warnings=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['enableDryRun'] = pulumi.Output.from_input(enable_dry_run).apply(json.dumps) if enable_dry_run is not None else None
            if kubeconfig is None:
                kubeconfig = _utilities.get_env('KUBECONFIG')
            __props__['kubeconfig'] = kubeconfig
            __props__['namespace'] = namespace
            __props__['renderYamlToDirectory'] = render_yaml_to_directory
            ...
            __props__['suppressDeprecationWarnings'] = pulumi.Output.from_input(suppress_deprecation_warnings).apply(json.dumps) if suppress_deprecation_warnings is not None else None
