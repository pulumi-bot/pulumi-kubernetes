...
class CertificateSigningRequest(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.CertificateSigningRequestSpec']] = pulumi.output_property("spec")
    """
    The certificate request itself and any additional information.
    """
    status: pulumi.Output[Optional['outputs.CertificateSigningRequestStatus']] = pulumi.output_property("status")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'CertificateSigningRequest':
        """
