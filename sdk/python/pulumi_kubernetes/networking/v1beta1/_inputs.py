...
class IngressClassArgs:
    ...
    # pylint: disable=no-self-argument
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['IngressClassSpecArgs']] = None) -> None:
        """
...
class IngressClassSpecArgs:
    ...
    """
    parameters: Optional[pulumi.Input['_core.v1.TypedLocalObjectReferenceArgs']] = pulumi.input_property("parameters")
    """
    Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters.
    """

    # pylint: disable=no-self-argument
    def __init__(__self__, *, controller: Optional[pulumi.Input[str]] = None, parameters: Optional[pulumi.Input['_core.v1.TypedLocalObjectReferenceArgs']] = None) -> None:
        """
