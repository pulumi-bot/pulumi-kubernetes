...
class Event(pulumi.CustomResource):
    ...
    """
    deprecated_count: pulumi.Output[Optional[float]] = pulumi.output_property("deprecatedCount")
    """
    Deprecated field assuring backward compatibility with core.v1 Event type
    """
    deprecated_first_timestamp: pulumi.Output[Optional[str]] = pulumi.output_property("deprecatedFirstTimestamp")
    """
    Deprecated field assuring backward compatibility with core.v1 Event type
    """
    deprecated_last_timestamp: pulumi.Output[Optional[str]] = pulumi.output_property("deprecatedLastTimestamp")
    """
    Deprecated field assuring backward compatibility with core.v1 Event type
    """
    deprecated_source: pulumi.Output[Optional['outputs.EventSource']] = pulumi.output_property("deprecatedSource")
    """
    Deprecated field assuring backward compatibility with core.v1 Event type
    """
    event_time: pulumi.Output[str] = pulumi.output_property("eventTime")
    """
    ...
    """
    reason: pulumi.Output[Optional[str]] = pulumi.output_property("reason")
    """
    Why the action was taken.
    """
    regarding: pulumi.Output[Optional['outputs.ObjectReference']] = pulumi.output_property("regarding")
    """
    The object this Event is about. In most cases it's an Object reporting controller implements. E.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.
    """
    related: pulumi.Output[Optional['outputs.ObjectReference']] = pulumi.output_property("related")
    """
    Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.
    """
    reporting_controller: pulumi.Output[Optional[str]] = pulumi.output_property("reportingController")
    """
    Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.
    """
    reporting_instance: pulumi.Output[Optional[str]] = pulumi.output_property("reportingInstance")
    """
    ID of the controller instance, e.g. `kubelet-xyzf`.
    """
    series: pulumi.Output[Optional['outputs.EventSeries']] = pulumi.output_property("series")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, action=None, api_version=None, deprecated_count=None, deprecated_first_timestamp=None, deprecated_last_timestamp=None, deprecated_source=None, event_time=None, kind=None, metadata=None, note=None, reason=None, regarding=None, related=None, reporting_controller=None, reporting_instance=None, series=None, type=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
