...
class APIService(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.APIServiceSpec']] = pulumi.output_property("spec")
    """
    Spec contains information for locating and communicating with a server
    """
    status: pulumi.Output[Optional['outputs.APIServiceStatus']] = pulumi.output_property("status")
    """
    Status contains derived information about an API server
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['_meta.v1.ObjectMetaArgs']]] = None, spec: Optional[pulumi.Input[pulumi.InputType['APIServiceSpecArgs']]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'APIService':
        """
