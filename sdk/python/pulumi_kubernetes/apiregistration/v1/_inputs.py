...
class APIServiceArgs:
    ...
    def __init__(__self__, *, api_version: Optional[pulumi.Input[str]] = None, kind: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input['ObjectMetaArgs']] = None, spec: Optional[pulumi.Input['APIServiceSpecArgs']] = None, status: Optional[pulumi.Input['APIServiceStatusArgs']] = None) -> None:
        """
        ...
        """
        __self__.api_version = 'apiregistration.k8s.io/v1'
