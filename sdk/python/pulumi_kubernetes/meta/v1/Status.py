...
class Status(pulumi.CustomResource):
    ...
    """
    code: pulumi.Output[Optional[float]] = pulumi.output_property("code")
    """
    Suggested HTTP return code for this status, 0 if not set.
    """
    details: pulumi.Output[Optional['outputs.StatusDetails']] = pulumi.output_property("details")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_version: Optional[pulumi.Input[str]] = None, code: Optional[pulumi.Input[float]] = None, details: Optional[pulumi.Input[pulumi.InputType['StatusDetailsArgs']]] = None, kind: Optional[pulumi.Input[str]] = None, message: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[pulumi.InputType['ListMetaArgs']]] = None, reason: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None) -> 'Status':
        """
